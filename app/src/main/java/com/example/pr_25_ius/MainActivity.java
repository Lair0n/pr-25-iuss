...
public class MainActivity extends AppCompatActivity {
    ...
    private int mCatSound, mChickenSound, mCowSound, mDogSound, mDuckSound, mSheepSound, mBibizanaSound, mSlonSound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSlonSound = loadSound("slon.mp3");
        mBibizanaSound = loadSound("obezyana.mp3");
        ...
        ImageView obezyana = findViewById(R.id.image_obezyana);
        obezyana.setOnClickListener(onClickListener);

        ImageView slon = findViewById(R.id.image_slon);
        slon.setOnClickListener(onClickListener);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            else if(v.getId() == R.id.image_obezyana){
                playSound(mBibizanaSound);
            } else if (v.getId() == R.id.image_slon) {
                playSound(mSlonSound);
            }
        }
    };
